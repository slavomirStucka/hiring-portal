      ...
      <div className="icons">
        ...
        {!hideElements && (
          <>
            ...
            <div
              className={`icon resume-analyzer ${
                activeTab === "/resume-analyzer" ? "active" : ""
              }`}
            >
            ...
            <div
              className={`icon blog ${activeTab === "/blog" ? "active" : ""}`}
            >
              <Link to="/blog">
                <FaBlog />
                <span>Blog</span>
            ...
            <div
              className={`icon resume-screening ${
                activeTab === "/resume-screening" ? "active" : ""
              }`}
            >
              <Link
                to="/resume-screening"
                onClick={() => setActiveTab("/resume-screening")}
              >
                <Dock />
